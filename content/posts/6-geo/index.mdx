...
- **Write for summarie** → assume your content will be compressed into 2–3 sentences by AI.
...
- **Use semantic dept** → synonyms, related terms, conversational phrasings to mirror AI prompts.
...
- **Track mentions** – tools like Perplexity Labs, ContentLab AI, and BrandMentions can measure if your brand/content is being cited

#### Brand mentions
- **Expand beyond your site** → Appear in forums, directories, reviews, news sites, and industry platforms.
- **Track AI mentions** → Use tools (Perplexity Labs, ContentLab AI, Seer’s trackers) to monitor “Share of Model.”

...
>###### Your website is no longer just for people or search engines. It also serves generative engines like ChatGPT. SEO still matters, but Generative Engine Optimization (GEO) is emerging fast and Bing is back in play. Consumers are shifting toward AI-driven search, especially in retail. Read on for practical GEO implementations.
...
### SEO is part of the equation

Search Engine Optimization (SEO) remains important in the long-term growth strategy, ensuring that products and ideas are discoverable. It starts with creating [high-quality content that speaks directly to different audiences](https://review.firstround.com/the-seo-tips-that-helped-tally-20-million-visits-a-month/) through personalized pages.
